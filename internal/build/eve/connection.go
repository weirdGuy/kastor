...
// configuration, read from KASTOR_MCP_<SERVER>_URL at startup. The pinned
// tool names become the connection's allow-list: the agent discovers exactly
// the tools the spec bound, nothing else the server happens to expose.
